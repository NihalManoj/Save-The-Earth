...
function draw(){
  ...
  if (gameState===end) {
    text("The world generates 3.5 million tons of solid waste every day.",(displayWidth-950),(displayHeight-300)/2)
    text("Together we can stop this and reduce our waste, making the \n world a cleaner and better place.",(displayWidth-950),(displayHeight-200)/2)
